...
@router.message_callback(callback_payload.BackToMyMiniTests.filter())
@router.message_callback(callback_payload.MyMiniTests.filter())
...
@router.message_callback(callback_payload.MiniTestDetails.filter())
@router.message_callback(callback_payload.BackToMiniTestDetails.filter())
async def handle_mini_test_details(
    update: updates.MessageCallback,
    payload: callback_payload.MiniTestDetails | callback_payload.BackToMiniTestDetails,
    facade: MessageCallbackFacade,
    dao: DAO,
    bot: Bot,
) -> None:
...
@router.message_callback(callback_payload.DeleteMiniTest.filter())
async def handle_delete_mini_test(
    update: updates.MessageCallback,
    payload: callback_payload.DeleteMiniTest,
    facade: MessageCallbackFacade,
    dao: DAO,
) -> None:
    user_id = update.user.user_id
...
@router.message_callback(callback_payload.DeleteMiniTestConfirm.filter())
async def handle_delete_mini_test_confirm(
    update: updates.MessageCallback,
    payload: callback_payload.DeleteMiniTestConfirm,
    facade: MessageCallbackFacade,
    dao: DAO,
) -> None:
    user_id = update.user.user_id
...
async def handle_add_mini_test_photo(
    update: updates.MessageCallback,
    payload: callback_payload.AddMiniTestPhoto,
    facade: MessageCallbackFacade,
    state: FSMContext,
    dao: DAO,
) -> None:
...
@router.message_callback(callback_payload.MiniTestAnswers.filter())
async def handle_mini_test_answers(
    update: updates.MessageCallback,
    payload: callback_payload.MiniTestAnswers,
    facade: MessageCallbackFacade,
    dao: DAO,
) -> None:
    user_id = update.user.user_id
...
@router.message_callback(callback_payload.AddMiniTestAnswer.filter())
async def handle_add_mini_test_answer(
    update: updates.MessageCallback,
    payload: callback_payload.AddMiniTestAnswer,
    facade: MessageCallbackFacade,
    state: FSMContext,
    dao: DAO,
) -> None:
...
async def handle_remove_mini_test_answer_list(
    update: updates.MessageCallback,
    payload: callback_payload.RemoveMiniTestAnswerList,
    facade: MessageCallbackFacade,
    dao: DAO,
) -> None:
    user_id = update.user.user_id
...
@router.message_callback(callback_payload.RemoveMiniTestAnswer.filter())
async def handle_remove_mini_test_answer(
    update: updates.MessageCallback,
    payload: callback_payload.RemoveMiniTestAnswer,
    facade: MessageCallbackFacade,
    dao: DAO,
) -> None:
    user_id = update.user.user_id
...
@router.message_callback(callback_payload.OpenMiniTestToProceed.filter())
async def handle_open_mini_test_to_proceed(
    _: updates.MessageCallback,
    payload: callback_payload.OpenMiniTestToProceed,
    facade: MessageCallbackFacade,
    dao: DAO,
) -> None:
    mini_test_id = payload.mini_test_id
...
@router.message_callback(callback_payload.ProceedMiniTest.filter())
async def handle_proceed_mini_test(
    update: updates.MessageCallback,
    payload: callback_payload.ProceedMiniTest,
    facade: MessageCallbackFacade,
    dao: DAO,
) -> None:
    user_id = update.user.user_id
