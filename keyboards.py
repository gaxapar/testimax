...
main_menu = [
    ...
    [
        types.CallbackButton(
            ...
            payload=callbacks.InteractiveTestsList(page=1).pack(),
        ),
    ],
]
...
def interactive_tests_page(
    ...
    keyboard = [
        [
            types.CallbackButton(
                ...
                payload=callbacks.OpenInteractiveTest(slug=interactive_test.slug).pack(),
            ),
        ]
    ...
    if page > 1:
        navigation_buttons.append(
            types.CallbackButton(
                text=texts.previous_page_button,
                payload=callbacks.InteractiveTestsList(page=page - 1).pack(),
            ),
        )
    ...
    return [
        [
            types.CallbackButton(
                ...
                payload=callbacks.ProceedInteractiveTest(slug=interactive_test.slug).pack(),
            ),
        ],
        [
            types.CallbackButton(
